...
export class TestFieldController implements DataServiceSubscriber, CodeMapMouseEventServiceSubscriber{
...
export const ribbonBarComponent = {
    ...
    template: require("./ribbonBar.html"),
    controller: TestFieldController
};

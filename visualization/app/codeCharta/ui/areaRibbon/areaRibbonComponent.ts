...
export class areaRibbonController implements DataServiceSubscriber, CodeMapMouseEventServiceSubscriber{
...
export const areaRibbonComponent = {
    selector: "areaRibbonComponent",
    template: require("./areaRibbon.html"),
    controller: areaRibbonController
};

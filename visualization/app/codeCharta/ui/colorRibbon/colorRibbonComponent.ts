...
export class collorRibbonController implements DataServiceSubscriber, CodeMapMouseEventServiceSubscriber{
...
export const colorRibbonComponent = {
    selector: "colorRibbonComponent",
    template: require("./colorRibbon.html"),
    controller: collorRibbonController
};
